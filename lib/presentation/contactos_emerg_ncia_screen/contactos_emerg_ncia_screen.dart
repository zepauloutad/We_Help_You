import '../contactos_emerg_ncia_screen/widgets/listuserone_item_widget.dart';
...
class ContactosEmergNciaScreen extends GetWidget<ContactosEmergNciaController> {
  @override
                                ...
                                child: Obx(
                                  () => ListView.separated(
                                    ...
                                    itemCount: controller
                                        .contactosEmergNciaModelObj
                                        .value
                                        .listuseroneItemList
                                        .value
                                        .length,
                                    itemBuilder: (context, index) {
                                      ListuseroneItemModel model = controller
                                          .contactosEmergNciaModelObj
                                          .value
                                          .listuseroneItemList
                                          .value[index];
                                      return ListuseroneItemWidget(
                                        model,
                                      );
                                    },
                                  ),
